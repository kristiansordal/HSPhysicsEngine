...
/* package HaskellPhysicsEngine-0.1.0.0 */
#ifndef VERSION_HaskellPhysicsEngine
#define VERSION_HaskellPhysicsEngine "0.1.0.0"
#endif /* VERSION_HaskellPhysicsEngine */
#ifndef MIN_VERSION_HaskellPhysicsEngine
#define MIN_VERSION_HaskellPhysicsEngine(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellPhysicsEngine */
...
#define CURRENT_COMPONENT_ID "HaskellPhysicsEngine-0.1.0.0-inplace-phy"
