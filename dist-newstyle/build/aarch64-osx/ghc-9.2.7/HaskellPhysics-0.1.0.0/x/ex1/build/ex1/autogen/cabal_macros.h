...
/* package HaskellPhysics-0.1.0.0 */
#ifndef VERSION_HaskellPhysics
#define VERSION_HaskellPhysics "0.1.0.0"
#endif /* VERSION_HaskellPhysics */
#ifndef MIN_VERSION_HaskellPhysics
#define MIN_VERSION_HaskellPhysics(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellPhysics */
...
#define CURRENT_COMPONENT_ID "HaskellPhysics-0.1.0.0-inplace-ex1"
