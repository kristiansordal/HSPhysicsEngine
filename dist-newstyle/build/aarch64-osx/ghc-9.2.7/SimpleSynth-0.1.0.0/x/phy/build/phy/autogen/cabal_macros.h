...
/* package SimpleSynth-0.1.0.0 */
#ifndef VERSION_SimpleSynth
#define VERSION_SimpleSynth "0.1.0.0"
#endif /* VERSION_SimpleSynth */
#ifndef MIN_VERSION_SimpleSynth
#define MIN_VERSION_SimpleSynth(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_SimpleSynth */
...
#define CURRENT_COMPONENT_ID "SimpleSynth-0.1.0.0-inplace-phy"
