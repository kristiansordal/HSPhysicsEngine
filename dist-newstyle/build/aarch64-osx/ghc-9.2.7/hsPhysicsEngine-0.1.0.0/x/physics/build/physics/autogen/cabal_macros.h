...
/* package hsPhysicsEngine-0.1.0.0 */
#ifndef VERSION_hsPhysicsEngine
#define VERSION_hsPhysicsEngine "0.1.0.0"
#endif /* VERSION_hsPhysicsEngine */
#ifndef MIN_VERSION_hsPhysicsEngine
#define MIN_VERSION_hsPhysicsEngine(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hsPhysicsEngine */
...
#define CURRENT_COMPONENT_ID "hsPhysicsEngine-0.1.0.0-inplace-physics"
